...
class MoviesFragment : Fragment() {
    ...
    private fun observeAnimeList(adapter: MoviesAdapter) {
    ...
    private fun handleScrollingToTopWhenLoaded(adapter: MoviesAdapter) = lifecycleScope.launch {
    ...
    private fun handleListVisibility(adapter: MoviesAdapter) = lifecycleScope.launch {
        getRefreshLoadStateFlow(adapter)
            .simpleScan(count = 3)
